    ...
    >
      <section>
        ...
        <p className="mt-4 text-base leading-7 text-slate-700">
          ...
          {kristiansandScheduleIntegrity.byYear["2026"] ?? 0} in 2026,{" "}
          {kristiansandScheduleIntegrity.byYear["2027"] ?? 0} in 2027 and{" "}
          {kristiansandScheduleIntegrity.byYear["2028"] ?? 0} in 2028, across{" "}
