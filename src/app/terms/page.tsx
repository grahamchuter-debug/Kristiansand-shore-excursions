...
export const metadata: Metadata = buildPageMetadata({
  title: "Terms of Use",
  description:
    "Terms of use for Kristiansand Shore Excursions: independent cruise planning information for Kristiansand port days.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <ContentPage
      title="Terms of Use"
      lead="These terms cover use of the Kristiansand Shore Excursions website as an independent informational planning resource."
      ...
      ctaTitle="Plan your Kristiansand cruise day"
      ctaText="Explore harbour, park and beach options, then verify timings with your cruise line."
      ctaHref="/excursions"
    ...
    >
      <section>
        ...
        <p>
          ...
          information about Kristiansand. It is not a substitute for official
