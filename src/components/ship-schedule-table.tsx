...
import {
  formatScheduleDate,
  type KristiansandScheduleEntry,
...
function compareValues(
  a: KristiansandScheduleEntry,
  b: KristiansandScheduleEntry,
  key: SortKey,
): number {
...
type ShipScheduleTableProps = {
  entries: KristiansandScheduleEntry[];
};
    ...
    <div className="space-y-4">
      <label className="block">
        <span className="mb-2 block text-sm font-medium text-slate-700">
          Search Kristiansand ship schedule
        </span>
        <input
          id="schedule-search"
          type="search"
          ...
          aria-label="Search Kristiansand ship schedule"
