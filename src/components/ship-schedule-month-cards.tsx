...
import {
  ...
  type getKristiansandMonthSummaries,
} from "@/lib/kristiansand-schedules";

type MonthSummary = ReturnType<typeof getKristiansandMonthSummaries>[number];
  ...
  return (
    <div className="space-y-10">
      ...
      <p className="text-sm leading-6 text-slate-500">
        ...
        {kristiansandScheduleIntegrity.lastDate
        ...
        <Link href={shipScheduleHubPath} className="content-link">
          Kristiansand ship schedule hub
        </Link>
        .
      </p>
    </div>
